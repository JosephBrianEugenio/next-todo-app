...
const BoardCardComponent = () => {
  ...
  return (
    <div className="flex gap-3 p-4">
      <div className="flex-none w-64 h-full bg-white p-4 rounded-lg shadow-xl border-2">
        ...
        {hasTask ? (
          <div className="text-sm text-gray-700 bg-gray-200 p-4 rounded-lg shadow-md border-2 max-w-sm overflow-hidden mb-2">
            <div className="py-4">
